...
public class TrianguloFractalAboutBox extends javax.swing.JDialog {

    public TrianguloFractalAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.rafaelsales.triangulofractal.TrianguloFractalApp.class).getContext().getResourceMap(TrianguloFractalAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.rafaelsales.triangulofractal.TrianguloFractalApp.class).getContext().getActionMap(TrianguloFractalAboutBox.class, this);
